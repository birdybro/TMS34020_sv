...
three-word ANDNI/ORI/XORI family, while blocking everything else. This verifies
a conservative fetch-to-commit ordering, but does not implement or measure
documented pipeline overlap.
