...
so its 8,491 logic-cell/2,048-register resource count is not a core-area
...
composition with zero errors/warnings to 5,131 logic cells, 1,414 registers,
