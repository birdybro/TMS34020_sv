...
ST preservation, complete MOVI.W/MOVI.L packet commits, unclassified-word
noncommit, and
...
so its 6,025 logic-cell/2,021-register resource count is not a core-area
...
composition with zero errors/warnings to 3,810 logic cells, 1,357 registers,
