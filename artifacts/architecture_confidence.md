...
| ISA | PROVISIONAL | 49 primary-page-verified encoding records/10,896 first words; complete extraction pending |
| Architectural model slice | PROVISIONAL | 43 page-verified encoding forms, including complete ADDK/INC, SUBK/DEC, MOVK, MOVI, MOVX, and MOVY forms, fetch through deterministic cache transaction/retry state; full ISA/interfaces absent |
| Synthesizable RTL slice | PROVISIONAL | Generated 49-entry partial decoder, serialized cache/fetch frontend, A/B/SP and masked ST storage, common unary/binary/logical arithmetic, six TMS34020-specific semantic leaves, and a bounded fetch-to-commit path for 24 one-word, four two-word, and eight three-word instructions pass directed Verilator and Cyclone V synthesis; MOVX/MOVY and other unsupported packets block, and no architectural retirement timing or complete executable core exists |
