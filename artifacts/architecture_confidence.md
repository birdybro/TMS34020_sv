...
| PC/control-flow boundary | VERIFIED_PRIMARY | Bit-address alignment/advance, redirect classes, reset vector, GETPC/EXGPC/JUMP, long JRcc conditions/target, DSJ/DSJS families, IDLE and interrupt checkpoint rules are extracted with page citations; JR.L has bounded model semantics but no RTL owner |
