...
| Architectural model slice | PROVISIONAL | All 52 currently extracted encoding forms have bounded successful semantics, including BLMOVE non-overlap/final state and TRAPL/VLCOL success paths, with fetch through deterministic cache transaction/retry state; ISA extraction remains incomplete, and BLMOVE continuation/overlap/timing, non-cache fault/retry, and full interfaces are absent |
