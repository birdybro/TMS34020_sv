...
| ISA | PROVISIONAL | 93 primary-page-verified encoding records/27,540 first words; four XY-conversion ranges add exact operand contracts. RSC-0025 discloses three contradictory CVXYL examples and RSC-0026 discloses the arbitrary-pitch 14/15-state timing conflict; prior CALL/RETS/TRAP/REV and short-JR uncertainties remain; complete extraction is pending |
| Architectural model slice | PROVISIONAL | 92 of 93 extracted forms have bounded successful semantics. Four XY conversions cover signed arithmetic, every pitch class, aliases, and unchanged ST; CVXYL arbitrary pitch provisionally selects 14 pending RSC-0026. CPW/CALL/RETS/TRAP retain coverage. REV alone remains atomically unsupported. Unextracted ISA, physical stack/fault behavior, BLMOVE continuation, and interfaces are absent |
