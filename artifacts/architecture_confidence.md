...
| ISA | PROVISIONAL | 42 primary-page-verified encoding records/6,736 first words; complete extraction pending |
| Architectural model slice | PROVISIONAL | 36 page-verified encoding forms fetch through deterministic cache transaction/retry state; full ISA/interfaces absent |
| Synthesizable RTL slice | PROVISIONAL | Generated 42-entry partial decoder, serialized cache/fetch frontend, A/B/SP and masked ST storage, common unary/binary/logical arithmetic, six TMS34020-specific semantic leaves, and a bounded fetch-to-commit path for 23 one-word, one two-word, and five three-word instructions pass directed Verilator and Cyclone V synthesis; SUBI packets and other unsupported packets block, and no architectural retirement timing or complete executable core exists |
