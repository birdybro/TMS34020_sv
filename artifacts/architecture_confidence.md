...
| Architectural model slice | PROVISIONAL | 50 page-verified encoding forms, including complete ADDK/INC, SUBK/DEC, MOVK, MOVI, MOVE, MOVX/MOVY, RL constant/register, SETCDP/SETCMP/SETCSP, and successful VLCOL forms, fetch through deterministic cache transaction/retry state; special-cycle fault/retry and full ISA/interfaces absent |
