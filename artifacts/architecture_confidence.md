...
| Architectural model slice | PROVISIONAL | 51 page-verified encoding forms, including complete ADDK/INC, SUBK/DEC, MOVK, MOVI, MOVE, MOVX/MOVY, RL constant/register, SETCDP/SETCMP/SETCSP, and successful TRAPL/VLCOL forms, fetch through deterministic cache transaction/retry state; BLMOVE, non-cache fault/retry, and full ISA/interfaces absent |
