...
| ISA | PROVISIONAL | 19 primary-page-verified entries/1,804 first words; complete extraction pending |
| Architectural model slice | PROVISIONAL | 13 page-verified instructions and deterministic state/replay; cache/full ISA absent |
| Synthesizable RTL slice | PROVISIONAL | Generated 19-entry partial decoder, A/B/SP storage, common unary operations, and six TMS34020-specific semantic leaves pass directed Verilator and Cyclone V synthesis; no sequencer/core |
