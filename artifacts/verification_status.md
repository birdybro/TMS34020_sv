...
| RTL semantics | Partial leaf slice | `make rtl-leaf-tests`: 24-entry partial decode, A/B/SP, masked ST, unary/binary arithmetic and TMS34020-specific leaves; no executable core |
