...
| Cache | Transaction-level model drives architectural fetch; RTL/timing absent | 11 cache-unit plus 5 fetch-integration tests under `make model-tests`; full `TMS20-0012` remains |
