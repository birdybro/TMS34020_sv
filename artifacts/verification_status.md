...
| Formal | No proof run; fifteen runtime SVAs simulation-enabled | Four cache, four fetch, five scalar, and two register-commit safety properties run under Verilator; SymbiYosys remains unavailable and `TMS20-0032` is not complete |
