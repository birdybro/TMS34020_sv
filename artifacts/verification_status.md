...
| RTL semantics | Partial leaves plus serialized cache/fetch frontend | Leaf and fetch suites cover decode/state/write intents and packet ordering; `make frontend-tests` covers cold refill, cache-hit extensions, bypass retry/fault-abort, PC reload and cache preservation; no packet-to-execution composition, timed retirement, or executable core |
