...
| RTL semantics | Partial leaf slice | `make rtl-leaf-tests`: 31-entry partial decode, A/B/SP, masked ST, unary/binary arithmetic, TMS34020-specific leaves, and decoder-controlled write intents for 19 one-word instructions; no executable core |
