...
- Analysis resources: 11,903 logic cells after synthesis, 2,230 registers,
  127 pins, 0 block-memory bits, 9 DSP blocks, and 0 PLLs
- Scope: generated 105-entry partial decoder, A/B/SP register file, masked ST state,
...
- Scope: generated 105-entry partial decoder, aligned instruction-start cursor,
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 803 logic cells, 373 registers, 82 pins, 4,096
  block-memory bits, 0 DSP blocks, and 0 PLLs
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 5,366 logic cells, 1,414 registers, 82 pins, 4,096
  block-memory bits, 0 DSP blocks, and 0 PLLs
- Memory inference: the integrated cache retains one portable 128×32 dual-port
  RAM mapped to `altsyncram`
