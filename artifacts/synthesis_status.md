...
- Analysis resources: 12,826 logic cells after synthesis, 2,230 registers,
  127 pins, 0 block-memory bits, 9 DSP blocks, and 0 PLLs
- Scope: generated 116-entry partial decoder, A/B/SP register file, masked ST state,
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 453 logic cells, 175 registers, 74 pins, 0 block-memory
  bits, 0 DSP blocks, and 0 PLLs
- Scope: generated 116-entry partial decoder, aligned instruction-start cursor,
