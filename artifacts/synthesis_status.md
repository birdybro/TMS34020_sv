...
- Analysis resources: 13,481 logic cells after synthesis, 2,230 registers,
  127 pins, 0 block-memory bits, 9 DSP blocks, and 0 PLLs
- Scope: generated 140-entry partial decoder, A/B/SP register file, masked ST state,
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 482 logic cells, 177 registers, 74 pins, 0 block-memory
  bits, 0 DSP blocks, and 0 PLLs
- Scope: generated 140-entry partial decoder, aligned instruction-start cursor,
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 878 logic cells, 375 registers, 82 pins, 4,096
  block-memory bits, 0 DSP blocks, and 0 PLLs
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 5,483 logic cells, 1,416 registers, 82 pins, 4,096
  block-memory bits, 0 DSP blocks, and 0 PLLs
- Memory inference: the integrated cache retains one portable 128×32 dual-port
  RAM mapped to `altsyncram`
