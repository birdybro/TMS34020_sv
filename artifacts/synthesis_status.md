...
- Analysis resources: 6,048 logic cells after synthesis, 2,021 registers,
...
- Scope: generated 50-entry partial decoder, A/B/SP register file, masked ST state,
  ...
  intents and externally gated state commit for 38 register/status instructions,
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 3,836 logic cells, 1,357 registers, 82 pins, 4,096
  block-memory bits, 0 DSP blocks, and 0 PLLs
- Memory inference: the integrated cache retains one portable 128×32 dual-port
  RAM mapped to `altsyncram`
- Scope: cache/fetch frontend, 38-operation register executor, A/B/SP and ST
