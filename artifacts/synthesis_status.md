...
- Scope: generated 149-entry partial decoder, A/B/SP register file, masked ST state,
  ...
  combinational normalized one-step PFILL PATTERN/COLOR0/COLOR1/PMASK/
  row-column traversal leaf,
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 528 logic cells, 177 registers, 74 pins, 0 block-memory
  bits, 0 DSP blocks, and 0 PLLs
- Scope: generated 149-entry partial decoder, aligned instruction-start cursor,
...
- Result: Analysis & Synthesis successful, 0 errors, 0 warnings
- Analysis resources: 903 logic cells, 375 registers, 82 pins, 4,096
  block-memory bits, 0 DSP blocks, and 0 PLLs
