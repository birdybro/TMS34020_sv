...
`ifndef SYNTHESIS
    ...
    property p_jr_long_commit_has_only_conditioned_redirect;
        @(posedge clk_i) disable iff (reset_i)
            commit_accepted_o &&
            packet_opcode_id_o == TMS20_OP_JR_L
            |-> !register_write_enable_o &&
    ...
    property p_jr_long_redirect_uses_signed_word_displacement;
        @(posedge clk_i) disable iff (reset_i)
            commit_accepted_o &&
            commit_pc_redirect_enable &&
            packet_opcode_id_o == TMS20_OP_JR_L
    ...
    property p_lmo_commit_has_atomic_register_and_status_writes;
        @(posedge clk_i) disable iff (reset_i)
            commit_accepted_o &&
            packet_opcode_id_o == TMS20_OP_LMO
            |-> register_write_enable_o &&
                status_write_enable_o &&
    ...
    property p_btst_commit_has_only_atomic_z_write;
        @(posedge clk_i) disable iff (reset_i)
            commit_accepted_o &&
            (
                packet_opcode_id_o == TMS20_OP_BTST_K ||
                packet_opcode_id_o == TMS20_OP_BTST_R
            )
            |-> !register_write_enable_o &&
                status_write_enable_o &&
                status_write_mask_o == 32'h2000_0000 &&
    ...
    property p_setf_commit_has_only_selected_status_bank_write;
        @(posedge clk_i) disable iff (reset_i)
            commit_accepted_o &&
            packet_opcode_id_o == TMS20_OP_SETF
            |-> !register_write_enable_o &&
                status_write_enable_o &&
                status_write_mask_o ==
                    (
    ...
    property p_field_extension_commit_is_atomic;
        @(posedge clk_i) disable iff (reset_i)
            commit_accepted_o &&
            (
                packet_opcode_id_o == TMS20_OP_SEXT ||
                packet_opcode_id_o == TMS20_OP_ZEXT
            )
            |-> register_write_enable_o &&
                status_write_enable_o &&
                status_write_mask_o ==
    ...
    assert property (
        p_jr_long_commit_has_only_conditioned_redirect
    );
    assert property (
